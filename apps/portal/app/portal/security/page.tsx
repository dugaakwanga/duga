...
import { Card, PageHeader, Badge, Alert, Spinner, Button, Field, Input, Icon } from "@duga/ui";
...
export default function SecurityGatePage() {
  ...
  return (
    <div>
      <PageHeader
        title="Gate & Visitors"
        subtitle="Scan a student's ID card, or type their admission number, to clock them in or out."
        actions={<Button variant="outline" onClick={() => router.push("/portal/security/id-cards")}>Print ID cards</Button>}
      />
